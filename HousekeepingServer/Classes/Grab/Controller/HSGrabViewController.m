...
@interface HSGrabViewController () <
    ...
    UICollectionViewDelegateFlowLayout, HSRegionColletionViewCellDelegate> {
...
- (NSArray *)regions {
  if (!_regions) {
    NSString *file =
        [[NSBundle mainBundle] pathForResource:@"citydata.plist" ofType:nil];
...
- (void)setupNavBarBtn {
  ...
  HSNavBarBtn *leftNavBtn =
      [HSNavBarBtn navBarBtnWithTitle:@"选择地区"
  ...
  HSNavBarBtn *rightNavBtn =
      [HSNavBarBtn navBarBtnWithTitle:@"选择服务"
                                image:@"navigation_city_fold"
                     highlightedImage:@"navigation_city_fold_highlighted"
                        selectedImage:@"navigation_city_unfold"];
...
- (void)setupRegionCollectionView {
  ...
  CGRect collectionViewF =
      CGRectMake(0, collectionViewY, collectionViewW, collectionViewH);
  regionCollectionView = [[UICollectionView alloc] initWithFrame:collectionViewF
  ...
  [regionCollectionView registerClass:[HSRegionCollectionViewCell class]
           forCellWithReuseIdentifier:@"Region"];
...
- (void)setupServiceTableView {
  // 初始化
  CGFloat tableViewW = XBScreenWidth * 0.5;
  CGFloat tableViewH = XBScreenHeight * 0.5;
  CGFloat tableViewX = XBScreenWidth - tableViewW;
  CGFloat tableViewY = self.tableView.contentOffset.y + 64;
  CGRect tableViewF =
      CGRectMake(tableViewX, tableViewY, tableViewW, tableViewH);
  serviceTableView = [[UITableView alloc] initWithFrame:tableViewF
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
  ...
  HSRegionCollectionViewCell *cell = (HSRegionCollectionViewCell *)
      [collectionView dequeueReusableCellWithReuseIdentifier:@"Region"
